...
public class PluginException extends RuntimeException {
   ...
   */
  public PluginException(InterledgerAddress pluginAccount) {
   ...
   *                method.
   */
  public PluginException(String message, InterledgerAddress pluginAccount) {
    super(message);
    this.pluginAccount = pluginAccount;
  }
   ...
   * @since 1.4
   */
  public PluginException(Throwable cause, InterledgerAddress pluginAccount) {
    super(cause);
    this.pluginAccount = pluginAccount;
  }
   ...
   * @since 1.7
   */
  public PluginException(String message, Throwable cause, boolean enableSuppression,
