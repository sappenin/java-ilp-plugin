 ...
 */
public class PluginNotConnectedException extends PluginException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not initialized, and may
   * subsequently be initialized by a call to {@link #initCause}.
   */
  public PluginNotConnectedException(InterledgerAddress pluginAccount) {
    super(pluginAccount);
  }
   ...
   *                method.
   */
  public PluginNotConnectedException(String message, InterledgerAddress pluginAccount) {
   ...
   * @since 1.4
   */
  public PluginNotConnectedException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public PluginNotConnectedException(Throwable cause,
                                     InterledgerAddress pluginAccount) {
