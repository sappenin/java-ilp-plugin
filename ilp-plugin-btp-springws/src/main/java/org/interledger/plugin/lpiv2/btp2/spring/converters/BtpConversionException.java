package org.interledger.plugin.lpiv2.btp2.spring.converters;

public class BtpConversionException extends RuntimeException {
  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not initialized, and may
   * subsequently be initialized by a call to {@link #initCause}.
   */
  public BtpConversionException() {
    super();
  }
   ...
   *                method.
   */
  public BtpConversionException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public BtpConversionException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   * @since 1.4
   */
  public BtpConversionException(Throwable cause) {
    super(cause);
  }
   ...
   * @since 1.7
   */
  protected BtpConversionException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
