...
/**
 * Thrown if a caller attempts to register a {@link MoneySender} with a {@link Plugin} where one is already
 * registered.
 */
public class MoneySenderAlreadyRegisteredException extends PluginException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not initialized, and may
   * subsequently be initialized by a call to {@link #initCause}.
   */
  public MoneySenderAlreadyRegisteredException(InterledgerAddress pluginAccount) {
    super(pluginAccount);
  }
   ...
   *                method.
   */
  public MoneySenderAlreadyRegisteredException(String message, InterledgerAddress pluginAccount) {
   ...
   * @since 1.4
   */
  public MoneySenderAlreadyRegisteredException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public MoneySenderAlreadyRegisteredException(Throwable cause,
      InterledgerAddress pluginAccount) {
