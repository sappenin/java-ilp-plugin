...
/**
 * Thrown if a caller attempts to register a {@link DataHandler} in a {@link Plugin} where one is already registered.
 */
public class DataHandlerAlreadyRegisteredException extends PluginException {
   ...
   */
  public DataHandlerAlreadyRegisteredException(InterledgerAddress pluginAccount) {
    super(pluginAccount);
  }
   ...
   *                method.
   */
  public DataHandlerAlreadyRegisteredException(String message, InterledgerAddress pluginAccount) {
   ...
   * @since 1.4
   */
  public DataHandlerAlreadyRegisteredException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public DataHandlerAlreadyRegisteredException(Throwable cause,
      InterledgerAddress pluginAccount) {
