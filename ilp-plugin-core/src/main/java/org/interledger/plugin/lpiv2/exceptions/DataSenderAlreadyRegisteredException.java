...
/**
 * Thrown if a caller attempts to register a {@link DataSender} with a {@link Plugin} where one is already
 * registered.
 */
public class DataSenderAlreadyRegisteredException extends PluginException {

  /**
   * Constructs a new runtime exception with {@code null} as its detail message.  The cause is not initialized, and may
   * subsequently be initialized by a call to {@link #initCause}.
   */
  public DataSenderAlreadyRegisteredException(InterledgerAddress pluginAccount) {
    super(pluginAccount);
  }
   ...
   *                method.
   */
  public DataSenderAlreadyRegisteredException(String message, InterledgerAddress pluginAccount) {
   ...
   * @since 1.4
   */
  public DataSenderAlreadyRegisteredException(String message, Throwable cause,
   ...
   * @since 1.4
   */
  public DataSenderAlreadyRegisteredException(Throwable cause,
      InterledgerAddress pluginAccount) {
