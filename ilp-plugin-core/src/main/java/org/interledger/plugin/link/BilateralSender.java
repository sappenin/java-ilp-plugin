...
/**
 * <p>A sender of Interledger financial data in a two-way link between two peers (i.e., bilateral).</p>
 *
 ...
 */
public interface BilateralSender {

  /**
   * <p>Sends an ILPv4 request packet to the connected peer and returns the response packet (if one is returned).</p>
   *
   ...
   *   actually happened on the bilateral receivers side of this link request.</ul>
   * </ol>
   * </pre>
   *
